...
<?php		if($totales['ingresos']){ ?>
			...
			<fieldset>
				...
				<label><strong>Cantidad de Transacciones : </strong><?php echo round($totales['transacciones'], 2); ?></label>
			<fieldset>
<?php } ?>
		...
		<table class="table table-striped table-bordered">
			...
			<tbody>
				...
				if($buscar=='buscar'){
					if($nivel=='USUARIO'){
				 		echo lista_movimientos_normal($filtro, $desde, $hasta, $cedula, $comprobante, $banco); 
				 	}else{
				 		echo lista_movimientos($filtro, $desde, $hasta, $cedula, $comprobante, $banco); 
				 	}
				}
				?>				
			</tbody>
