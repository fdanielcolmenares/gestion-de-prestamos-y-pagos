...
<?php if($usuario){ ?>
        <div class="navbar navbar-inverse print">
	...
	<?php if($nivel == 'ADMINISTRADOR'  || $nivel == 'ASISTENTE' ){ ?>
              <li class="dropdown">
               ...
               <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                ...
                <li><a href="?e=14">Reporde de Cargas</a></li>
                <li><a href="?e=15">Reporde Fondo de Contingencia</a></li>
                <li><a href="?e=16">Reporde de Cr&eacute;ditos</a></li>
                <li><a href="?e=17">Reporde de Cuotas</a></li>
               </ul>
             </li>
	<?php } ?>
