<div class="alert alert-block ">
  ...
  La ultima transacci&oacute;n registrada no se ha completado, debe finalizarla antes de poder continuar...
	...
	<legend class="">Detalle de la venta</legend>
	...
	<div class="control-group">
	  ...
	  <div class="controls">
	    <input id="ventas_cantidad" name="compras_cantidad" type="number" placeholder="" class="span4" required="">
	...
	<div class="control-group">
	  ...
	  <div class="controls">
	    <button type="submit" id="guias_bottonguardar" name="guardar_venta" value="guardar_venta"  class="btn btn-success">Procesar</button>
	  </div>
	</div>
