...
if($guardar == 'personas_guardar'){
	...
	$estatus  = $_POST['personas_estatus'];
	 ...
	 ModPer($cedula, $nombre, $apellido, $rif, $direccion, $fecha_ingreso, $telf1, $telf2, $telf3, $fecha_nacimiento, $tipo, $estatus);
    ...
    <!--CONTENEDOR-->
     <div class="container">
         <div class="row-fluid">
			...
			<legend class="text-center">Modificar Registro</legend>

			<!-- Text input-->
			<div class="control-group">
			  <label class="control-label" for="personas_cedula">Cédula:</label>
			  <div class="controls">
			    <input id="personas_cedula" name="personas_cedula" type="text" placeholder="" class="span4" required="" value="<?php echo $datos['cedula']; ?>">
			...
			<div class="control-group">
			  ...
			  <div class="controls">
			    <input id="personas_nombre" name="personas_nombre" type="text" placeholder="" class="span4"required="" value="<?php echo $datos['nombre']; ?>">
			...
			<div class="control-group">
			  ...
			  <div class="controls">
			    <input id="personas_apellido" name="personas_apellido" type="text" placeholder="" class="span4"required="" value="<?php echo $datos['apellido']; ?>">
			...
			<div class="control-group">
			  ...
			  <div class="controls">
			    <input id="Personas_rif" name="personas_rif" type="text" placeholder="" class="span4"required="" value="<?php echo $datos['rif']; ?>">
			...
			<div class="control-group">
			  ...
			  <div class="controls">
			    <input id="personas_direccion" name="personas_direccion" type="text" placeholder="" class="span4"required="" value="<?php echo $datos['direccion']; ?>">
			...
			<div class="control-group">
			  ...
			  <div class="controls">
			    <input id="personas_fecha" name="personas_fecha" type="date" placeholder="xx/yy/zzzz" class="span4"required="" value="<?php echo $datos['fecha_ingreso']; ?>">
			...
			<div class="control-group">
			  ...
			  <div class="controls">
			    <input id="personas_telefono1" name="personas_telefono1" type="text" placeholder="" class="span4"required="" value="<?php echo $datos['telefono1']; ?>">
			...
			<div class="control-group">
			  ...
			  <div class="controls">
			    <input id="personas_telefono2" name="personas_telefono2" type="text" placeholder="" class="span4" value="<?php echo $datos['telefono2']; ?>">
			...
			<div class="control-group">
			  ...
			  <div class="controls">
			    <input id="personas_telefono3" name="personas_telefono3" type="text" placeholder="" class="span4" value="<?php echo $datos['telefono3']; ?>">
			...
			<div class="control-group">
			  ...
			  <div class="controls">
			    <input id="personas_fechanacimiento" name="personas_fechanacimiento" type="date" placeholder="xx/yy/zzzz" class="span4"required="" value="<?php echo $datos['fecha_nacimiento']; ?>">
			...
			<div class="control-group">
			  ...
			  <div class="controls">
			    <button id="personas_guardar" name="personas_guardar" value="personas_guardar" class="btn btn-success" type="submit">Modificar</button>
