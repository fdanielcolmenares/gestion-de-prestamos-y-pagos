	...
	<?php if($persona['nombre']){ ?>
	    <form class="form-horizontal" method="POST">
			...
			<div class="control-group">
			  ...
			  <div class="controls">
			    <input id="administracion_fecha" name="administracion_fecha" type="text" placeholder="" class="span4" required="" value="<?php echo date('Y-m-d'); ?>" readonly="readonly">
			...
			<div class="control-group">
			  ...
			  <div class="controls">
			    <select id="administracion_concepto_ingresos" name="administracion_concepto" class="input-xlarge" disabled="true">
			      <option>--Seleccione--</option>
			      <option value="VENTAS">Ventas</option>
			      <option value="SEGUROS">Fonde de contingencia</option>
			      <option value="APORTES">Aportes</option>
			      <option value="PAGOS">Pago de cr&eacuto;ditos</option>
			      <option value="REVERSOS">Ajuste</option>
			...
			<div class="control-group">
			  ...
			  <div class="controls">
			    <select id="administracion_concepto_egresos" name="administracion_concepto" class="input-xlarge" disabled="true">
			      ...
			      <option value="CREDITOS">Asignaci&oacute;n de creditos</option>
    			      <option value="REVERSOS">Ajuste</option>
				<option value="HISTORICO">Historico</option>
			    </select>
			  </div>
