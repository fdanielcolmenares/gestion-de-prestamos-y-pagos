         ...
         <div class="row-fluid">
			...
			<fieldset>
				...
				<div class="control-group">
				  ...
				  <div class="controls">
				    <input id="usuarios_cedula" name="usuarios_cedula" type="text" placeholder="" class="span4" required="">
				  </div>
				</div>
				...
				<div class="control-group">
				  ...
				  <div class="controls">
				    <input id="usuarios_nombre" name="usuarios_nombre" type="text" placeholder="" class="span4" required="">
